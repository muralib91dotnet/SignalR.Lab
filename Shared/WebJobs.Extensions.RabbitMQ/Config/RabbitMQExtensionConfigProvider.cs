...
namespace Microsoft.Azure.WebJobs.Extensions.RabbitMQ
{
    ...
    internal class RabbitMQExtensionConfigProvider : IExtensionConfigProvider
    {
        ...
        internal IRabbitMQService GetService(string connectionString, string hostName, QueueSetting queueSetting, string userName, string password, int port, ExchangeSetting deadLetterExchangeSetting)
        {
            return _rabbitMQServiceFactory.CreateService(connectionString, hostName, queueSetting, userName, password, port, deadLetterExchangeSetting);
        }
